 ...
 *
 * PURPOSE:
 * Renders the Booking Confirmation Email editor: copy fields (eyebrow,
 * heading, intro, resort rules heading/intro, closing, footer), a
 * read-only reminder that the actual resort rules text is edited
 * under Content > Policies, and a gallery-style image manager (add,
 * reorder, caption, delete) — everything services/
 * bookingConfirmationEmail.js reads when a booking is confirmed.
 *
 * DATA FLOW:
    ...
    <section className="bceSection">
      ...
      <div className="bceHeaderRow">
        <div>
          ...
          <h1 className="bceTitle">Booking Confirmation Email</h1>
        </div>
