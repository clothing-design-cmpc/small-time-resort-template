...
<body>
  ...
  vaultSecurity: {
    ...
    steps: [
      ...
      "The vault passphrase itself (the value that pairs with VAULT_SETUP_KEY above) is set later, in Step 6 of this wizard, using node scripts/hashVaultPassphrase.js — a separate terminal-only script, not something generated here.",
    ],
    codeBlocksIntro:
