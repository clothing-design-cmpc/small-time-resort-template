...
export default function TourReservationSummaryClient({ checkInDate, bookingType, roomId, resortPhone, resortMessengerUsername }) {
  ...
  async function onSubmit(formValues) {
    ...
    // comment there. The actual navigation is deferred to the invoice
    // auto-download effect above (via pendingMessengerHandoffRef) so
    // the guest gets the PDF first, then gets routed to Messenger.
