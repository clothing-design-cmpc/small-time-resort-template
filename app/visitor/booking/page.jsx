 ...
 * 3. Dynamic design tier: the header copy fades/slides in on load via
 *    ScrollReveal (trigger="mount" — there's nothing to scroll into
 *    view above it, it's the first thing on the page)
 */
  ...
  return (
    <section className="bookingSection">
      <div className="bookingContainer">
        <ScrollReveal as="div" trigger="mount">
