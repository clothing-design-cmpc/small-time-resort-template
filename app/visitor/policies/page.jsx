 ...
 * 4. Dynamic design tier: the hero fades in on mount, then each policy
 *    section (Booking, Refund, House Rules, Check-In/Out, Privacy) fades
 *    in as the visitor scrolls to it — page.jsx itself stays a Server
 *    Component since ScrollReveal carries its own "use client" boundary
 */
  ...
  return (
    <main className="policiesMain">
      ...
      <section className="policiesHero">
        <ScrollReveal as="div" className="policiesHeroContainer" trigger="mount">
      ...
      <section className="policiesBody">
        <div className="policiesBodyContainer">
          ...
          <div className="policiesContent">
            ...
            {/* ── Booking Policies ── */}
            <ScrollReveal as="section" id="booking-policies" className="policiesSection">
            ...
            <ScrollReveal as="section" id="refund-policies" className="policiesSection">
            ...
            {/* ── House Rules ── */}
            <ScrollReveal as="section" id="house-rules" className="policiesSection">
            ...
            {/* ── Check-In / Check-Out ── */}
            <ScrollReveal as="section" id="checkin-times" className="policiesSection">
            ...
            {/* ── Privacy Policy ── */}
            <ScrollReveal as="section" id="privacy" className="policiesSection">
