 ...
 * 4. Dynamic design tier: the section content fades/slides in once it
 *    scrolls into view, and the three differentiator cards stagger in
 *    one after another via the shared ScrollReveal/RevealGroup
 *    primitives — this file itself stays a Server Component since those
 *    wrappers carry their own "use client" boundary
 */
...
export default function About() {
  return (
    <section className="aboutSection" id="about">
      <ScrollReveal as="div" className="aboutContainer">
        ...
        <RevealGroup as="div" className="aboutDifferentiators">
          {differentiators.map((item) => (
            <RevealItem as="article" className="aboutDifferentiatorCard" key={item.id}>
