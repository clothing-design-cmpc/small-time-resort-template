 ...
 * 3. Dynamic design tier: header fades in on scroll, then the 8 amenity
 *    cards stagger in one after another via the shared motion primitives
 */
  ...
  return (
    <section className="amenitiesHighlightSection" id="amenities">
      <div className="amenitiesHighlightContainer">
        <ScrollReveal as="div" className="amenitiesHighlightHeader">
        ...
        <RevealGroup as="div" className="amenitiesHighlightGrid" stagger={0.05}>
          {amenities.map(({ id, label, description, Icon }) => (
            <RevealItem as="div" key={id} className="amenityHighlightCard">
