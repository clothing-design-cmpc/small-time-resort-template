 ...
 * 4. Dynamic design tier: header fades in on scroll, product cards
 *    stagger in one after another, and each card lifts slightly on hover
 *    (see MiniStoreSection.css for the accompanying image zoom)
 */
  ...
  return (
    <section className="miniStoreSection" id="shop">
      <div className="miniStoreContainer">
        ...
        {/* Section header */}
        <ScrollReveal as="div" className="miniStoreHeader">
        ...
        {/* Product grid */}
        <RevealGroup as="div" className="miniStoreGrid" stagger={0.06}>
          {PRODUCTS.map((product) => (
            <RevealItem as="article" key={product.id} className="miniStoreCard" hoverLift>
        ...
        {/* Footer note */}
        <ScrollReveal as="p" className="miniStoreFootnote">
