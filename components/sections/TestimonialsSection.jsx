 ...
 * 3. Dynamic design tier: header fades in on scroll, then the 3 review
 *    cards stagger in one after another
 */
  ...
  return (
    <section className="testimonialsSection" id="testimonials">
      <div className="testimonialsContainer">
        <ScrollReveal as="div" className="testimonialsHeader">
          <span className="testimonialsEyebrow">Guest Reviews</span>
          <h2 className="testimonialsTitle">What Guests Say</h2>
        </ScrollReveal>

        <RevealGroup as="div" className="testimonialsGrid" stagger={0.1}>
          {testimonials.map((t) => (
            <RevealItem as="article" key={t.id} className="testimonialCard">
